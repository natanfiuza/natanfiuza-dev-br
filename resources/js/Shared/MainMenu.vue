  ...
  <div>
    ...
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/organizations">
        ...
        <div :class="isUrl('organizations') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Organizações</div>
      </Link>
    </div>
    <div class="mb-4">
      <Link class="group flex items-center py-3" href="/contacts">
        ...
        <div :class="isUrl('contacts') ? 'text-white' : 'text-indigo-300 group-hover:text-white'">Contatos</div>
      </Link>
    </div>
    <div class="mb-4">
